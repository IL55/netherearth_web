...
describe('getTerrainRule — antigrav (best: full speed everywhere)', () => {
    ...
    it('sand: passable, speed 1',      () => expect(getTerrainRule('S',  Chassis.ANTIGRAV)).toEqual({ passable: true, speedFactor: 1 }));
...
describe('getTerrainRule — tracks (any terrain except holes, slower than antigrav on grass)', () => {
    ...
    it('sand: passable, speed 0.5',       () => expect(getTerrainRule('S',  Chassis.TRACKS)).toEqual({ passable: true,  speedFactor: 0.5  }));
...
describe('getTerrainRule — bipod (grass and sand only, always slower)', () => {
    ...
    it('sand: passable, speed 0.5',   () => expect(getTerrainRule('S',  Chassis.BIPOD)).toEqual({ passable: true,  speedFactor: 0.5 }));
